...
console.log(findMissingNumber('22 24 6 26 7 23 29 14 4 a 17 12 9 10 1 2 20 28 13 19 16 a a a 11 a 8 27')); //return 1

function findMissingNumber(sequence) {
    if (sequence === '') return 0;
    let arr = sequence.split(" ").sort((a,b)=>a-b).map(a => parseInt(a));
